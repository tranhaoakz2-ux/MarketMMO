...
src/
  ...
  app/
    ...
    admin/xac-thuc/page.tsx           # AdminVerificationsPanel — di chuyển từ AdminDashboard cũ
  ...
  components/  # Header, NavMegaMenu (dropdown hover Sản phẩm/Dịch vụ/Nạp tiền),
               ...
               # SellerTelegramPanel, SellerVerificationPanel, ProductVariantManager (gồm cả
    ...
    admin/     # Component riêng cho Admin Control Center (theme tối, xem globals.css):
               ...
               # AdminVerificationsPanel, AdminProductsPanel, AdminCategoriesPanel
               # (5 panel này migrate 1:1 logic từ AdminDashboard.tsx cũ — component gộp
               ...
               # action ngay trên dòng), AdminUsersPanel, AdminSellersPanel,
...
.../variants` tạo phiên bản → nếu phiên bản đó có dán kho, `POST .../stock`
    ...
    **Admin duyệt** (`/admin/san-pham`, `AdminProductsPanel.tsx`, cùng
...
16. **Admin Control Center** (`/admin`, dựng lại HOÀN TOÀN từ trang quản trị
    ...
    - **Làm hết 1 lần** (không phased rollout): toàn bộ 13 mục sidebar đều có
      ...
      6 mục duyệt PENDING đã có sẵn (Nạp tiền, Rút tiền, Khiếu nại, Xác thực
      CCCD, Sản phẩm, Danh mục) vào theme mới.
...
- [x] **Admin Control Center** (`/admin`, dựng lại hoàn toàn từ trang quản trị
      ...
      sidebar/theme tối riêng biệt (13 mục), gồm cả 6 mục di chuyển từ trang
      cũ (Nạp tiền, Rút tiền — **giữ nguyên logic duyệt tay thật**; Khiếu
      nại — bấm dòng mở modal chi tiết; Sản phẩm/Danh mục/Xác thực CCCD chờ
