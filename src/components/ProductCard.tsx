...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col rounded-lg border-2 border-brand bg-surface shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-brand-dark hover:shadow-[0_12px_28px_rgba(43,176,191,0.35),0_4px_10px_rgba(0,0,0,0.05)] mmo-surface-card"
    >
