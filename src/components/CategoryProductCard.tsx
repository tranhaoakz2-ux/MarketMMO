...
export default function CategoryProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col rounded-lg border-2 border-transparent bg-surface shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-brand hover:shadow-[0_12px_28px_rgba(224,196,0,0.25),0_4px_10px_rgba(0,0,0,0.05)] dark:bg-[var(--card-navy)]"
    >
