...
// (CategorySidebar.tsx). Sinh đôi với /danh-muc/[slug]/page.tsx (cùng bố cục
// Header/Breadcrumb/sidebar/lưới sản phẩm/Pagination/Footer) nhưng KHÔNG lọc
// theo category nào — dùng getAllProducts() thay vì getProductsByCategory().
// Tách file riêng (không gộp vào [slug]/page.tsx bằng slug đặc biệt) để
// không đụng/rủi ro tới logic gộp đệ quy category cha/con đã có ở trang đó.
      ...
      <main className="flex-1 bg-background">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 pb-12 sm:px-6 lg:flex-row lg:px-8">
          <Reveal direction="right" className="lg:sticky lg:top-24 lg:self-start">
            <CategorySidebar activeSlug="" categories={tree} posts={recentPosts} />
          </Reveal>
