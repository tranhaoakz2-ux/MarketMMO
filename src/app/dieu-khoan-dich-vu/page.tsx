...
const sections = [
  {
    ...
    body: "Khi truy cập và sử dụng maketmmo.com, bạn đồng ý tuân thủ toàn bộ điều khoản dịch vụ này cùng các chính sách liên quan (Chính sách bảo mật, Điều khoản bán hàng). Nếu không đồng ý, vui lòng ngừng sử dụng nền tảng.",
  },
  {
