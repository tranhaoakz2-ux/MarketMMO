...
const sections = [
  ...
  },
  {
    ...
    body: "Người bán có thể tự nguyện nạp quỹ bảo hiểm cho gian hàng của mình — đây không phải điều kiện bắt buộc để được bán hàng trên MarketMMO. Quỹ bảo hiểm hiển thị công khai trên trang sản phẩm như một tín hiệu uy tín, giúp gian hàng tạo thêm niềm tin với người mua. Khi có khiếu nại đủ điều kiện phát sinh sau khi đơn đã giải ngân (không còn tiền ký quỹ để hoàn), MarketMMO có thể quyết định đền bù cho người mua một phần hoặc toàn bộ giá trị đơn hàng, trích từ quỹ bảo hiểm của người bán đó — số tiền đền bù không vượt quá số dư quỹ hiện có của gian hàng tại thời điểm xử lý.",
  },
  {
