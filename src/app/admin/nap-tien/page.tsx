...
export default async function AdminDepositsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Nạp tiền"
        subtitle="Duyệt/từ chối yêu cầu nạp tiền thủ công (chuyển khoản ngân hàng / USDT). Tự động hoá qua VNPay sẽ thay thế luồng này khi tích hợp thanh toán tự động — hiện vẫn cần admin xác nhận thủ công."
      />
      <AdminDepositsPanel />
    </div>
  );
